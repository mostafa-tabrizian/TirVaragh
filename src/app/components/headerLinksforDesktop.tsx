               ...
               <div className='text-gray-700'>
                  <Link href='/'>
                     <div className='relative flex items-center'>
                        <span className='flex cursor-pointer items-center gap-x-2 py-2 font-bold hover:text-red-600 md:py-1'>
                           <svg
                           ...
                           <span className='whitespace-nowrap text-base text-inherit'>
                              صفحه اصلی
                           </span>
                        </span>
                     </div>
