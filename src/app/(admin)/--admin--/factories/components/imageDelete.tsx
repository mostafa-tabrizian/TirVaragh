...
const ImageDelete = ({ imageKey, factoryId }: { imageKey: string; factoryId: string }) => {
   ...
   return (
      <>
         <div className='absolute right-2 top-0 flex w-10 items-center justify-end space-x-3 rounded-full bg-red-500/90 opacity-0 transition-opacity hover:opacity-100'>
            {loading ? (
               <div className='py-2'>
                  <svg
