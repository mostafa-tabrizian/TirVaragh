...
export const metadata = {
   title: 'تیرورق | پنل ادمین | اسلاید ها',
}
               ...
               slides.map((slide) => {
                  return (
                     <div key={slide._id} className='relative'>
                        ...
                        <Link
                           target='_blank'
                           href={`https://tabrizian.storage.iran.liara.space/tirvaragh/slides/${slide.src}`}
                        >
                           <Image
                              className='rounded-xl aspect-video'
                              src={`https://tabrizian.storage.iran.liara.space/tirvaragh/slides/${slide.src}`}
                              alt={slide.alt}
                              width={690}
                              height={388.125}
                              objectFit='contain'
